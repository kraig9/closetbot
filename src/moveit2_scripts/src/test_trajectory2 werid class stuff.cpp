      ...
      : Node("test_trajectory"),
        ...
        joint_model_group_arm(
            move_group_arm.getCurrentState()->getJointModelGroup(
                PLANNING_GROUP_ARM)) {
      RCLCPP_INFO(LOGGER, "are we in the constructor??");
      this->timer_ =
